...
export default function GallerySection() {
  ...
  return (
    <section id="photos" className="scroll-mt-[120px] border-t border-bone-200 bg-white text-ink-700">
      <div className="mx-auto max-w-[1280px] px-6 pb-[100px] pt-[96px] lg:px-8">
        ...
        {isDemoContent ? (
          <p className="mt-6 bg-bone-100 px-5 py-3 text-[14px] text-ink-500">
